...
# -*- coding: utf-8 -*-
"""
Plot fraction of HZ planets in the fixed duration CHZ
"""
...
#import results from fixed duration CHZ calculation from "compute_fCHZ_grid.py"
CHZ_df= pd.read_csv("outputs/CHZ_df_2Gyr.csv")
CHZ_df2= pd.read_csv("outputs/CHZ_df_4Gyr.csv")
...
#%% plot fraction of planets in fixed duration CHZ
...
fig, ax = plt.subplots()
cs=ax.contourf(M,A,FP, levels=nlvl,vmin=0.0, vmax=1.0,cmap=cmapname)
...
ax.set_title("2 Gyr CHZ", fontsize=fsize)
...
cs2=ax2.contourf(M,A,FP2, levels=nlvl,vmin=0.0, vmax=1.0,cmap=cmapname)
...
ax2.set_title("4 Gyr CHZ", fontsize=fsize)
